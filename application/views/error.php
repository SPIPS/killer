...
<html lang="fr">
  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <div class="jumbotron">
        <h1>Erreur :-(</h1>
        <p class="lead"><?php global $app; if(is_array($app['erreur'])){ foreach($app['erreur'] as $e) { echo $e."<br />"; } } else { echo $app['erreur']; } ?></p>
        <a class="btn btn-large btn-warning" href="#" onclick="javascript:window.history.back();">Revenir à la page précédante</a>
      </div>
